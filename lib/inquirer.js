...
module.exports = {
    ...
    const QUESTIONS = [
      ...
      },
      {
        ...
        validate(input) {
          ...
          return 'Project name must be over 4 characters long and may only include letters, numbers, underscores and hashes.';
        },
      },
    ];
    return inquirer.prompt(QUESTIONS);
  ...
  askHTTPs: () => {
    const QUESTIONS = [
    {
      name: 'HTTPS_option',
      type: 'input',
      message: 'Would you like to set up Https connection? You would need certificate file content and private key contents',
    }
    ];
    return inquirer.prompt(QUESTIONS);
  },
