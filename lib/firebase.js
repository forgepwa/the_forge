...
module.exports = {
  ...
  deploy(firebaseName, projectDirName) {
    ...
    client
      ...
      .catch(err => {
        console.log(
          `Unable to deploy 😔. Please make sure that the firebase project name you entered (${firebaseName}) matches your firebase project name at https://console.firebase.google.com --- Error: ${err}`
        );
      });
  }
};
