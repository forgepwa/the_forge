...
module.exports = {
  ...
  async FBLogin(projectDirName) {
    ...
    // .then((token) => process.env.FIREBASE_TOKEN = token)
    // .then(() => this.useAdd(projectDirName))
    // .catch(err => console.log(err));
    // let token = await this.setFBToken();// this.getStoredFBToken();
